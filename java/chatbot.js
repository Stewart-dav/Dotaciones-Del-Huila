...
function procesarConsulta(mensaje) {
    ...
    if (texto.includes("contacto") || texto.includes("asesor") || texto.includes("humano") || texto.includes("vendedor") || texto.includes("whatsapp") || texto.includes("hablar con alguien")) {
    ...
    if (texto.includes("protección visual") || texto.includes("gafas") || texto.includes("lentes") || texto.includes("visual")) {
        categoriasSolicitadas.push({ id: "protección visual", label: "Protección Visual" });
    }

    if (texto.includes("protección manual") || texto.includes("guantes") || texto.includes("manos") || texto.includes("manual")) {
        categoriasSolicitadas.push({ id: "protección manual", label: "Protección Manual" });
    }
    ...
    if (texto.includes("primeros auxilios") || texto.includes("botiquín") || texto.includes("auxilios")) {
        categoriasSolicitadas.push({ id: "primeros auxilios", label: "Primeros Auxilios" });
    }

    if (texto.includes("señalización") || texto.includes("señales") || texto.includes("carteles") || texto.includes("avisos")) {
        categoriasSolicitadas.push({ id: "señalización", label: "Señalización" });
    }

    if (texto.includes("uniformes dama") || texto.includes("dama") || texto.includes("mujer") || texto.includes("femenino")) {
        categoriasSolicitadas.push({ id: "uniformes dama", label: "Uniformes Dama" });
    }

    if (texto.includes("alturas") || texto.includes("lineas de vida") || texto.includes("vida") || texto.includes("arnés")) {
        categoriasSolicitadas.push({ id: "alturas", label: "Alturas" });
    }

    if (texto.includes("uniformes hombre") || texto.includes("hombre") || texto.includes("masculino")) {
        categoriasSolicitadas.push({ id: "uniformes hombre", label: "Uniformes Hombre" });
    }

    if (texto.includes("protección personal") || texto.includes("protección") || texto.includes("personal")) {
        categoriasSolicitadas.push({ id: "protección personal", label: "Protección Personal" });
    }

    if (texto.includes("higiene y aseo") || texto.includes("higiene") || texto.includes("aseo") || texto.includes("limpieza")) {
        categoriasSolicitadas.push({ id: "higiene y aseo", label: "Higiene y Aseo" });
    }

    if (texto.includes("mascotas") || texto.includes("perro") || texto.includes("gato") || texto.includes("animal")) {
        categoriasSolicitadas.push({ id: "mascotas", label: "Mascotas" });
    }
